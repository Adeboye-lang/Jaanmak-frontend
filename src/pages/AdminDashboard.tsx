               ...
               <div className="space-y-8">
                  <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-pink-50">
                     ...
                     <form onSubmit={handleSaveProduct} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <input placeholder="Weight (e.g., 500ml)" value={productForm.weight || ''} onChange={e => setProductForm({ ...productForm, weight: e.target.value })} className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-pink-200" />
